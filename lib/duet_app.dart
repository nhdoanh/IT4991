...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  XFile? pickedVideo;
  VideoPlayerController? videoPickedController;
  ...
  Widget _videoPickedPreview() {
    if (videoPickedController == null) {
      return Container();
    } else {
      return AspectRatio(
        aspectRatio: videoPickedController!.value.aspectRatio,
        child: VideoPlayer(
          videoPickedController!,
        ),
      );
    }
  }
  ...
  /// Icon the video picker
  Widget _imagePickerVideo() {
    return Expanded(
      child: IconButton(
  ...
  Future<void> _onPressedImagePicker() async {
    // Pick a video
    pickedVideo = await _picker.pickVideo(source: ImageSource.gallery);

    if (pickedVideo == null) return;
    videoPickedController = VideoPlayerController.file(File(pickedVideo!.path));

    await videoPickedController?.initialize();
    setState(() {});

    videoPickedController?.play();
  }
